...
Author: KaotickJ (https://github.com/kaotickj)
"""
...
def run_detection():
    ...
    for variation in variations:
        ...
        if check_http_response(variation):
            try:
                ...
                output_text.insert(tk.END, f"Error getting whois for domain {variation}: {e}\n")
        else:
    ...
    with open(os.path.join(reports_dir, report_filename), "w") as report_file:
        ...
        report_file.write(
            f"<p><em>This report was generated by TypoSquatter Buster courtesy of <a href='https://github.com/kaotickj' target='_blank'>Kaotick Jay</a></em></p>")
